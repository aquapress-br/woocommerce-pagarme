...
abstract class Marketplace {
	...
	public static function form_schema() {
		$schema = array(
			...
			'document_cpf'         => array(
				'required'          => true,
				'label'             => __( 'CPF', 'wc-pagarme' ),
				'max'               => false,
				'min'               => false,
				'size'              => false,
				'type'              => 'regex',
				'equal'             => array( '/^\d{3}\.\d{3}\.\d{3}\-\d{2}$/' ),
			...
			'document_cnpj'          => array(
				...
				'size'              => false,
				'type'              => 'regex',
				'equal'             => array( '/^\d{2}\.\d{3}\.\d{3}\/\d{4}\-\d{2}$/' ),
				'sanitize_callback' => 'wc_pagarme_only_numbers',
				'error_msg'         => __( 'Insira um valor válido para o campo CNPJ.', 'wc-pagarme' ),
			),
			'full_name'             => array(
				'required'          => true,
			...
			'main_address_street_number' => array(
				'required'          => false,
				'label'             => __( 'Número', 'wc-pagarme' ),
				'max'               => 99999999,
				'min'               => 1,
			...
			'main_address_neighborhood'  => array(
				'required'          => false,
				'label'             => __( 'Bairro', 'wc-pagarme' ),
				'max'               => 100,
				'min'               => 1,
			...
			'transfer_interval'        => array(
				'required'          => true,
				'label'             => __( 'Periodicidade da Transferencia', 'wc-pagarme' ),
				'max'               => false,
				'min'               => false,
				'size'              => false,
				'type'              => 'string',
				'equal'             => array( 'daily', 'weekly', 'monthly' ),
				'sanitize_callback' => 'wc_pagarme_sanitize_string',
				'error_msg'         => __( 'Insira valores válidos para o campo "Periodicidade da Transferencia": Diária, Mensal ou Semanal.', 'wc-pagarme' ),
			),
			'weekly_transfer_day'           => array(
				'required'          => false,
				'label'             => __( 'Dia da Semana', 'wc-pagarme' ),
				'max'               => 5,
				'min'               => 1,
				'size'              => false,
				'type'              => 'int',
				'equal'             => false,
				'sanitize_callback' => 'wc_pagarme_only_numbers',
				'error_msg'         => __( 'Insira valores válidos para o campo "Dia da Semana".', 'wc-pagarme' ),
			),
			'monthly_transfer_day'           => array(
				'required'          => false,
				'label'             => __( 'Dia do Mês', 'wc-pagarme' ),
				'max'               => 30,
				'min'               => 1,
				'size'              => false,
				'type'              => 'int',
				'equal'             => false,
				'sanitize_callback' => 'wc_pagarme_only_numbers',
				'error_msg'         => __( 'Insira valores válidos para o campo "Dia do Mês".', 'wc-pagarme' ),
			),
		);
