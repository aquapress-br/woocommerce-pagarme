...
if ( ! function_exists( 'wc_pagarme_get_template_part' ) ) {
	/**
	 * Get template part
	 *
...
if ( ! function_exists( 'wc_pagarme_get_template' ) ) {
	/**
	 * Get Template Part
	 *
...
if ( ! function_exists( 'wc_pagarme_locate_template' ) ) {
	/**
	 * Locate Template
	 *
	 * @param string $template_name Name of template.
...
if ( ! function_exists( 'wc_pagarme_get_template_override' ) ) {
	/**
...
if ( ! function_exists( 'wc_pagarme_get_template_override_directories' ) ) {
	/**
...
if ( ! function_exists( 'wc_pagarme_get_template_path' ) ) {
	/**
