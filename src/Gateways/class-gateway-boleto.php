...
class WC_Pagarme_Banking_Ticket_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title         = __( 'Pagar.me - Banking Ticket', 'wc-pagarme' );
		$this->method_description   = __( 'Accept banking ticket payments using Pagar.me.', 'wc-pagarme' );
		...
		add_action( 'woocommerce_scheduled_subscription_payment_pagarme-banking-ticket', array( $this, 'scheduled_subscription' ), 10, 2 );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'        => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Pagar.me Banking Ticket', 'wc-pagarme' ),
				'default' => 'no',
			),
			'title'          => array(
				...
				'desc_tip'    => true,
				'default'     => __( 'Banking Ticket', 'wc-pagarme' ),
			),
			'description'    => array(
				...
				'desc_tip'    => true,
				'default'     => __( 'Pay with Banking Ticket', 'wc-pagarme' ),
			),
			'integration'    => array(
			...
			'async'          => array(
				'title'       => __( 'Async', 'wc-pagarme' ),
				'type'        => 'checkbox',
				'description' => sprintf( __( 'If enabled the banking ticket url will appear in the order page, if disabled it will appear after the checkout process.', 'wc-pagarme' ) ),
				'default'     => 'no',
			),
			'testing'        => array(
